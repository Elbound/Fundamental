    ...
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            try
            {
                ...
                {
                    case "insert":
                        decimal inp = decimal.Parse(argument);
                        vm.InsertMoney(inp);
                        break;
                    case "select":
                        vm.PurchaseItem(argument);
                        System.Console.WriteLine("sukses!!");
                        System.Console.ReadLine();
                        break;
                    case "refund":
                        decimal refund = vm.Refund();
                        System.Console.WriteLine("refunded = " + refund);
                        System.Console.ReadLine();
                        break;
                    case "quit":
                        return;
                    default:
                        statusMessage = "Perintah tidak dikenal";
                        break;
                }
